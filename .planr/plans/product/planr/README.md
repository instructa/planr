...
- Codex, Claude Code, Cursor, and explicitly opted-in Grok Build and Pi should work through standard native, CLI, or MCP integration paths as their runtimes support.
