...
description: Complete Planr 1.10.0-alpha.8 tools/list inventory with every property, type, description, required field, enum/default declaration, and additionalProperties rule.
---
...
```json
{
  ...
  "properties": {
    "freeze_id": {
      "description": "Exact active source-freeze id",
      "type": "string"
    },
    "plan_id": {
      "description": "Exact plan id",
      "type": "string"
    },
    "reason": {
    ...
    "run_id": {
      "description": "Exact FeatureRun id",
      "type": "string"
    },
    "run_index_digest": {
      "description": "Required only for post-seal reasons; forbidden for pre-seal reasons",
      "type": "string"
    },
    "run_revision": {
      "description": "Exact optimistic FeatureRun revision",
      "type": "integer"
    }
  },
  "required": [
