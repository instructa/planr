  ...
  "properties": {
    "input": {
      ...
      "properties": {
        ...
        "schema_version": {
          "const": "planr.evidence.host_capture.admission.v1",
          "type": "string"
        }
      },
      "required": [
  ...
  "properties": {
    "input": {
      ...
      "properties": {
        ...
        "run_index": {
          "description": "Exact sealed planr.evidence.run-index.v2 object returned by admission",
          "type": "object"
        },
        "run_index_entry": {
          "const": 0,
        ...
        "schema_version": {
          "const": "planr.evidence.host_capture.import.v1",
          "type": "string"
        }
      },
      "required": [
