...
description: Complete Planr 1.6.0 tools/list inventory with every property, type, description, required field, enum/default declaration, and additionalProperties rule.
---
...
```json
{
  ...
  "properties": {
    ...
    "kind": {
      "description": "Context kind (default discovery)",
      "type": "string"
    }
  },
  "required": [
