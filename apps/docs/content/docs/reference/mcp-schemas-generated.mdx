...
```json
{
  ...
  "properties": {
    "input": {
      "description": "planr.evidence.recover_settlement.v1, planr.evidence.backfill_risk_review_obligations.v1, or planr.evidence.reconcile_historical_invalidation.v1 payload",
      "type": "object"
    }
  },
  "required": [
