...
const HTTP_ROUTE_MANIFEST = [
  ...
  ['POST starts_with:/v1/plans/&ends_with:/run/repair-verification-admission', '/v1/plans/{id}/run/repair-verification-admission'],
  ...
  ['POST exact:/v1/evidence/host-capture/admit', '/v1/evidence/host-capture/admit'],
