...
- `grok.svg`: Planr-owned neutral `G` monogram used to identify the Grok Build integration without redistributing a third-party brand asset

Retrieved on 2026-07-17. The three third-party marks remain the property of their respective owners and must be used according to those owners' current brand guidelines; the neutral Grok Build monogram is original Planr artwork.
