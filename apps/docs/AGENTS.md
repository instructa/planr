...
Next.js 16 and Fumadocs on Cloudflare Workers through Alchemy v2 and OpenNext.
...
- Never commit `.env.local`, `.alchemy`, `.open-next`, or generated `wrangler.jsonc` output from local tooling.
