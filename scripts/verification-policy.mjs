...
export const GATES = Object.freeze({
  ...
  "security": "Run repository security and privacy checks",
...
export const POLICY_RULES = deepFreeze([
  ...
  {
    id: "release-security",
    description: "Workflows, release, packaging, and security infrastructure",
...
function selectProfile(matches) {
  if (matches.some((match) => match.profile === "release-security")) return "release-security";
