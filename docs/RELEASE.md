...
It does not replay the Rust, docs, security, or packaging suites already proven
by that CI run. Editing manifests by hand or publishing an unprepared commit
