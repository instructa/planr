...
The npm package name is `planr` and exposes a Node wrapper for local development and consumer E2E testing.
...
The npm wrapper looks for a native binary in this order:
