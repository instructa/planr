...
The site currently owns 55 MDX routes. Next.js also emits the landing page and framework support routes during the production build.
...
- [x] All 55 current MDX routes are explicitly inventoried.
